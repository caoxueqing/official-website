							...
							<table id="bloodpressure"
								...
								<tbody>
									...
									<?php if(is_array($reportArray)): $i = 0; $__LIST__ = $reportArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="report">
										...
										<td><?php echo ($vo["tempe_rature"]); ?></td>
						...
						<div class="panel panel-default">
							<div class="panel-body panel-body-nopadding">
								<form class="form-horizontal form-bordered" method="post"
									id="save-bg-form">
									<div class="form-group">
										<label class="col-sm-3 control-label">体温值</label>
										<div class="col-sm-4">
											<input type="text" name="tempe_rature" class="form-control" />
										</div>
									</div>
									<div class="form-group">
