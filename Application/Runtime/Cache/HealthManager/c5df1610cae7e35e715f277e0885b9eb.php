														...
														<div class="form-group">
															<div class="col-lg-10">
																<div class="row">
																	...
																	<div class="col-lg-2">
																		<input id="txtName" type="text" class="form-control"  value=""  onclick="LoadUserList()" data-toggle="modal" data-target="#myModal">
																	...
																	<div class="col-lg-2">
																		<input type="text" id="txtbirth" class="form-control" value="" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd' })">
																	</div>
																</div>
															</div>
														</div>
