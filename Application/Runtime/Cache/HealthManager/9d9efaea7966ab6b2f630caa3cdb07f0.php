		...
		<div class="box" style="padding:15px 15px;">
			<div style="padding-left: 10px; padding-right: 10px;width: 100%;min-height: 1px;">
				<ul class="nav nav-tabs nav-dark" id="myTab" style="background:#ddd">
					<li class="active"><a href="#alreadyReply">已回复</a></li>
					<li><a href="#noReply">未回复</a></li>
				</ul>
				<div class="tab-content mb30">
					<div class="tab-pane active" id="alreadyReply">
					<form method="post" id="get-answer-form">
						<div id="alreadyReplydiv" class="panel-group">
							<!-- 循环开始 -->
							<?php if(is_array($alreadyReplyArray)): $i = 0; $__LIST__ = $alreadyReplyArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="panel panel-default" style="margin-top: 0px;">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="collapsed" data-toggle="collapse" data-parent="#alreadyReplydiv" href="#alreadyReplydiv<?php echo ($v["ask_id"]); ?>" onclick="getAnswerData(<?php echo ($v["doctor_id"]); ?>,<?php echo ($v["ask_id"]); ?>)">
												<?php echo ($v["content"]); ?>
												<br/>
									...
									<div class="panel-collapse collapse" id="alreadyReplydiv<?php echo ($v["ask_id"]); ?>" style="height: 0px;">
										<div class="panel-body hid">
					...
					<!-- 已回复 end -->
					<div class="tab-pane" id="noReply">
						<div id="noReplydiv" class="panel-group">
							<!-- 循环开始 -->
							<?php if(is_array($noReplyArray)): $i = 0; $__LIST__ = $noReplyArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="panel panel-default" style="margin-top: 0px;border-radius:0px">
									<div class="panel-heading" style="padding: 0px 0px;border-radius:0px">
										<h4 class="panel-title">
											<a class="collapsed" style="display:block;padding: 10px 15px;" data-toggle="collapse" data-parent="#noReplydiv" href="#noReplydiv<?php echo ($v["ask_id"]); ?>">
												<?php echo ($vo["content"]); ?>
												<br/>
												<img src="<?php echo ($vo["url"]); ?>" style="width: 80px">
												<br/>
												<?php echo ($vo["create_time"]); ?>
											</a>
										</h4>
									</div>
									<!-- <div class="panel-collapse collapse" id="noReplydiv<?php echo ($v["ask_id"]); ?>" style="height: 0px;">
