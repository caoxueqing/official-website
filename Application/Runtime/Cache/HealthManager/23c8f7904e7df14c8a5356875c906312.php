...
<body class="hold-transition login-page">
	<div class="login-box" style="margin: 7% auto 2% auto;">
		<div class="login-logo">
			<a href="<?php echo U(signIn);?>">个人管理登录</a>
		</div>
		<!-- /.login-logo -->
	...
	<div class="row">
		<div style="margin: 0px auto 2% auto; width: 387px;padding: 0px 20px 0px 30px;">
			...
			<div class="social-login-buttons">
				<!-- <a class="btn btn-link-1" style="background: #4862a3; color: #ffffff;" href="<?php echo U('Doctor/signIn');?>"> 
					<i class="fa fa-user-md"></i> 医生管理平台
				</a> 
