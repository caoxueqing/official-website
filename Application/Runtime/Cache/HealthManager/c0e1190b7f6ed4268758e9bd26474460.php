...
<link rel="stylesheet" type="text/css" href="/Public/AdminLTE/plugins/wdate/bootstraps.min.css"/> 
<script src="/Public/AdminLTE/plugins/echarts/echarts.common.min.js"></script> 
<div class="row">
	<div class="col-xs-12">
		<div class="box" style="padding: 15px 15px;">
			<div
				style="padding-left: 10px; padding-right: 10px; width: 100%; min-height: 1px;">
				<ul class="nav nav-tabs nav-dark" style="background: #ddd"
					id="myTab">
					<li class="active"><a href="#all">历史数据</a></li>
					...
					<div class="tab-pane active" id="all">
						<div class="table-responsive">
							<table id="bloodpressure"
								...
								<tbody>
									<!-- <?php if($reportArray != NULL): ?>-->
									<?php if(is_array($reportArray)): $i = 0; $__LIST__ = $reportArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="report">
										<td><?php echo ($vo["detect_time"]); ?></td>
										<td><?php echo ($vo['blood_sugar']); ?></td>
										<?php if($vo['report_type'] == 1): ?><td><?php echo ($vo["report_url"]); ?></td>
										<?php else: ?>
										<td><?php echo ($vo["content"]); ?></td><?php endif; ?>
										<!-- <td><?php echo ($vo["reference_range"]); ?></td> -->
										<td><a href="<?php echo ($vo["report_url"]); ?>">查看详情</a></td>
									</tr><?php endforeach; endif; else: echo "" ;endif; ?>
									<!-- <?php else: ?> -->
									<!-- <p
										style="font-size: 14px; color: #666; text-align: center; height: 200px; line-height: 200px;"
										class="noShop">对不起，没有信息！</p><?php endif; ?> -->
								</tbody>
							</table>
									...
									<div class="panel-body">
										<div class="form-group" style="height: 50px;">
											...
											<div class="control-group">
						                        <div  class="controls input-append date form_date" data-date="" data-date-format=" yyyy年MMdd日  " data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
						                          <input size="16" id="rtime" type="text" style="width: 50%; height: 30px;font-size: 12px; value="" placeholder="请点击获取日期" readonly>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<div class="rdio rdio-success" style="width: 100px;height: 25px;">
													<input type="radio" id="rday" value="1" name="rdotime" checked style="float:left;margin-right: 5px;/>
													<label for="rday">日</label>
												</div>
												<div class="rdio rdio-success" style="width: 100px;height: 25px;">
													<input type="radio" id="rweeks" value="2" name="rdotime"  style="float:left;margin-right: 5px;">
													<label for="rweeks">周</label>
												</div>
												<div class="rdio rdio-success" style="width: 100px;height: 25px;">
													<input type="radio" id="rmonth" value="3" name="rdotime"  style="float:left;margin-right: 5px;">
									...
									<div class="panel-footer">
										<div class="row">
											<div class="col-sm-9 col-sm-offset-3">
												<input class="btn btn-primary" type="button" onclick="getBSData(1);" value="确定"/>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-md-9">
							    ...
							    <script type="text/javascript">
							        ...
							        var option = {
							            title: {
							                text: '血糖趋势图',
							                subtext: '标准范围值6-9-mmol/L'
							            },
							            tooltip: {},
							            legend: {
							                data:['血糖浓度']    //与series中的name对应
							            },
							            toolbox: {
									        show: true,
									        feature: {
							            ...
							            xAxis: {
							         		data: <?php echo json_encode(array_keys($result))?> //指定x轴分组["2016-11-07 09:29:09"] 
							            },
							            yAxis: {},
							            series: [       //添加对应的name柱形图
								            {
