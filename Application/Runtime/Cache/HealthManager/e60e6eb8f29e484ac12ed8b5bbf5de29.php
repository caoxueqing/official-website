								...
								<div class="col-md-9">
									...
									<script type="text/javascript">
										...
										var option = {
											title : {
												text : '血压趋势图',
												subtext : '标准范围值:舒张压<90--140mmHg>,收缩压<60--90mmHg>'
											},
											tooltip : {},
											legend : {
												data : [ '舒张压','收缩压' ]
							...
							<div class="panel panel-default">
								<div class="panel-body panel-body-nopadding">
									<form class="form-horizontal form-bordered" method="post" id="save-bg-form">
										<div class="form-group">
											<label class="col-sm-3 control-label" for="ssy">收缩压</label>
											<div class="col-sm-4">
												<input type="text" id="ssy" class="form-control" name="avg_sp" onkeyup="clearNoNum(this)" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label" for="szy">舒张压</label>
											<div class="col-sm-4">
												<input type="text" id="szy" class="form-control" name="avg_dp" onkeyup="clearNoNum(this)" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label" for="xl">心率</label>
											<div class="col-sm-4">
												<input type="text" id="xl" class="form-control" name="avg_hr" onkeyup="clearNoNum(this)" />
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-4">
											<!-- readonly="readonly" -->
												<input type="text" name="detect_start_time"  class="form-control">
												<!-- <input type="text" id="time" name="detect_start_time" class="form-control"  onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })"> -->
											</div>
										</div>
									</form>
								</div>
								...
								<div class="panel-footer">
									<div class="row">
										<div class="col-sm-6 col-sm-offset-3">
											<button class="btn btn-primary" type="button" onclick="saveDBPData();">保存</button>&nbsp;
