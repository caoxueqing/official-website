		...
		<div class="col-xs-12">
			<div class="box">
				<!-- <div class="box-header">
					<a href="javascript:;" style="float: left">健康报表</a>
				</div> -->
				<!-- /.box-header -->
				<div class="box-body">
					<table id="mainTable" class="table table-bordered table-striped">
						...
						<?php if($reportArray != NULL): if(is_array($reportArray)): $i = 0; $__LIST__ = $reportArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="report">
									...
									<td style="width: 105px;"><?php echo ($vo["title"]); ?></td>
						...
						<?php else: ?>
							<p style="font-size:14px;color:#666;text-align: center;height: 200px;line-height: 200px;" class="noShop">对不起，健康报表信息！</p><?php endif; ?>
						<!--<div class="checkall ">
