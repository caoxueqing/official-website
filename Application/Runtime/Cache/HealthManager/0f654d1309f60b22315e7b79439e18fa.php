...
<link rel="stylesheet" href="/Public/AdminLTE/bootstrap/css/style.css" rel="stylesheet">
<!-- Font Awesome -->
...
<link rel="stylesheet"
	href="/Public/AdminLTE/dist/css/skins/_all-skins.min.css">
<link rel="stylesheet" href="/Public/AdminLTE/plugins/wdate/datePicker.css" media="all" />
						...
						<div class="col-md-12 mb20">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="baseinfo">
									<table class="table table-bordered mb30" id="arctable">
										<tbody>
											<tr>
												<td>姓名</td>
												<td id="tinyName"><?php echo ($userInfo["tinyName"]); ?></td>
												<td>性别</td>
												<?php if($userInfo["sex"] == 1): ?><td id="sex">男</td>
												<?php else: ?>
													<td id="sex">女</td><?php endif; ?>
												<td>出生日期</td>
												<td id="birth"><?php echo ($userInfo["birthday"]); ?></td>
											</tr>
											<tr>
												<td>详细现住址</td>
												<td id="addnow" colspan="3"><?php echo ($userInfo["address"]); ?></td>
												<td>所属社区</td>
												<td id="shequ"></td>
											</tr>
											<tr>
												<td>详细户籍住址</td>
												<td id="addold" colspan="3"></td>
												<td>籍贯</td>
												<td id="jiguan"></td>
											</tr>
											...
											<tr>
												...
												<td id="leixin">身份证</td>
												<td>证件号码</td>
												<td id="idcard"><?php echo ($userInfo["idno"]); ?></td>
												<td>工作单位</td>
												<td id="GongZuoDanWei"></td>
											</tr>
											<tr>
												<td>民族</td>
												<td id="nation"></td>
											...
											<tr>
												<td>本人电话</td>
												<td id="JiaTinDianHua"></td>
												<td>本人手机</td>
												<td id="brphone"><?php echo ($userInfo["mobile"]); ?></td>
												<td>本人邮件</td>
												<td id="bremail"><?php echo ($userInfo["email"]); ?></td>
											</tr>
											<tr>
												<td>联系人姓名</td>
												<td id="LianXiRenName"></td>
												<td>联系人手机</td>
												<td id="LianXiRenDianHua"></td>
												<td>联系人邮件</td>
												<td id="LianXiRenEmail"></td>
											</tr>
											<tr>
												<td>婚姻状况</td>
												<td id="HunYingZhuangKuang"></td>
												<td>文化程度</td>
												<td id="WenHuaChengDu"></td>
												<td>职业</td>
												<td id="ZhiYe"></td>
											</tr>
											...
											<tr>
												<td>医疗费用支付方式</td>
												<td colspan="5" id="YiLiao"></td>
											</tr>

											<tr>
												<td>饮食情况</td>
												<td colspan="5" id="DietHabit"></td>
											</tr>
											<tr>
												<td>吸烟史</td>
												<td colspan="5" id="Somke"></td>
											</tr>
											<tr>
												<td>饮酒史</td>
												<td colspan="5" id="DrinkRate"></td>
											</tr>
											<tr>
												<td>锻炼情况</td>
												<td colspan="5" id="Sports"></td>
											</tr>
											<tr>
												<td>视力情况</td>
												<td colspan="5" id="shili"></td>
											</tr>
											<tr>
												<td>牙齿情况</td>
												<td colspan="5" id="yachi"></td>
											</tr>
											<tr>
												<td>睡眠情况</td>
												<td colspan="5" id="shuimian"></td>
											</tr>
											<tr>
												<td>药物过敏史</td>
												<td colspan="5" id="Drug"></td>
											</tr>
											<tr>
												<td>暴露史</td>
												<td colspan="5" id="BaoLu"></td>
											</tr>
											<tr>
												<td colspan="6">01疾病史</td>
											</tr>
											<tr>
												<td colspan="6" id="JiBing"></td>
											</tr>

											<tr>
												<td colspan="6">02手术史</td>
											</tr>
											<tr>
												<td colspan="6" id="SS"></td>
											</tr>
											<tr>
												<td colspan="6">03外伤史</td>
											</tr>
											<tr>
												<td colspan="6" id="WS"></td>
											</tr>
											<tr>
												<td colspan="6">04输血史</td>
											</tr>
											<tr>
												<td colspan="6" id="SX"></td>
											</tr>
											<tr>
												<td colspan="6">05家族史</td>
											</tr>
											<tr>
												<td>1.父亲</td>
												<td colspan="5" id="FQ"></td>
											</tr>
											<tr>
												<td>2.母亲</td>
												<td colspan="5" id="MQ"></td>
											</tr>
											<tr>
												<td>3.兄弟姐妹</td>
												<td colspan="5" id="XD"></td>
											</tr>
											<tr>
												<td>4.子女</td>
												<td colspan="5" id="ZN"></td>
											</tr>

											<tr>
												<td>06遗传病史</td>
												<td colspan="5" id="YiChuanBing"></td>
											</tr>
											<tr>
												<td>07残疾情况</td>
												<td colspan="5" id="CanJi"></td>
											</tr>

											<tr>
												<td colspan="6">08生活环境</td>
											</tr>
											<tr>
												<td>1.厨房排风设施</td>
												<td colspan="5" id="chufang"></td>
											</tr>
											<tr>
												<td>2.燃料类型</td>
												<td colspan="5" id="ranliao"></td>
											</tr>
											<tr>
												<td>3.饮水</td>
												<td colspan="5" id="yinshui"></td>
											</tr>
											<tr>
												<td>4.厕所</td>
												<td colspan="5" id="cesuo"></td>
											</tr>
											<tr>
												<td>5.禽兽栏</td>
												<td colspan="5" id="qinshou"></td>
											</tr>
...
<!-- /.row --> <!-- Modal -->
<div class="modal fade" id="sstReportUrl" tabindex="-1" role="dialog"
	aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">心电贴</h4>
			</div>
			<div class="modal-body">
				<!-- /.box-header -->
				<div class="form-group">
					<div class="touxiang" style="margin-left: 15px">
						<?php if(is_array($reportArray)): $i = 0; $__LIST__ = $reportArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="img" id="localImag">
							<?php if($vo['report_url'] != NULL): ?><!-- <img src="<?php echo ($vo["report_url"]); ?>" alt="" style="margin-top: 0px; margin-bottom: 10px;" /> -->
							<a href="<?php echo ($vo["report_url"]); ?>">报告图片</a> <?php else: ?>
							<p
								style="font-size: 14px; color: #666; text-align: center; height: 200px; line-height: 200px;"
								class="noShop">对不起，没有报告图片！</p><?php endif; ?>
						</div><?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
					<input type="hidden"
						value="<?php echo ($_SESSION['Sess_']['userInfo']['uid']); ?>" name="uid"
						id="uid" />
				</div>
				<!-- /.box-footer -->
			</div>
