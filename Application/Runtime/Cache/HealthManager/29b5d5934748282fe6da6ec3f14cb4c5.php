          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div>
                <!-- text input -->
                <div class="form-group">
                  <label>名称</label> <input name="description" type="text" value="<?php echo ($userData["tinyName"]); ?>"
                    class="form-control" placeholder="请输入您的名称" disabled>
                </div>
                <div class="form-group">
                  <label>邮箱</label> <input name="app_id" type="text" value="<?php echo ($userData["email"]); ?>"
                    class="form-control" placeholder="请输入您的邮箱" disabled>
                </div>
                <div class="form-group">
                  <label>手机号</label> <input name="app_secret" type="text" value="<?php echo ($userData["mobile"]); ?>"
                    class="form-control" placeholder="请输入您的手机号" disabled>
                </div>
                <div class="form-group">
                  <label>地址</label> <input name="callback_url" type="text" value="<?php echo ($userData["address"]); ?>"
                    class="form-control" placeholder="请输入您的地址" disabled>
                </div>
                <input class="btn btn-danger" style="float: right" type="submit" value="提交">
              </div>
            </div>
            <!-- /.box-body -->
          </div>
