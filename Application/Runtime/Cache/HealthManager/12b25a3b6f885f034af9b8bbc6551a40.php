				...
				<div class="tab-content mb30">
					<div class="tab-pane active" id="system">
						<div id="systemdiv" class="panel-group">
							<!-- 循环开始 -->
							<?php if(is_array($systemMessageArray)): $i = 0; $__LIST__ = $systemMessageArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="panel panel-default" style="margin-top: 0px;border-radius:0px">
									<div class="panel-heading" style="padding: 0px 0px;border-radius:0px">
										<h4 class="panel-title">
											<a class="collapsed" style="display:block;line-height: 37px;text-indent: 10px;" data-toggle="collapse" data-parent="#systemdiv" href="#systemdiv<?php echo ($v["message_id"]); ?>" onclick="ChangeState(<?php echo ($v["message_id"]); ?>,'system',<?php echo ($v["status"]); ?>);">
												<lable style="width:100px;margin-right: 100px;"><?php echo ($v["title"]); ?></lable><?php echo ($v["add_time"]); ?>
												<?php if($v["status"] == 0): ?><i id="system<?php echo ($v["message_id"]); ?>" status='<?php echo ($v["status"]); ?>' class="status" style="margin-left: 30px;">未读</i>
												<?php else: ?>
													<i id="system<?php echo ($v["message_id"]); ?>" status='<?php echo ($v["status"]); ?>' class="status" style="margin-left: 30px;">已读</i><?php endif; ?>
											</a>
										</h4>
									</div>
									<div class="panel-collapse collapse" id="systemdiv<?php echo ($v["message_id"]); ?>" style="height: 0px;">
					...
					<div class="tab-pane" id="health">
						<div id="healthdiv" class="panel-group">
							<!-- 循环开始 -->
							<?php if(is_array($healthMessageArray)): $i = 0; $__LIST__ = $healthMessageArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="panel panel-default" style="margin-top: 0px;">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="collapsed" data-toggle="collapse" data-parent="#healthdiv" href="#healthdiv<?php echo ($v["message_id"]); ?>" onclick="ChangeState(<?php echo ($v["message_id"]); ?>,'health',<?php echo ($v["status"]); ?>);">
												<lable style="width:100px;margin-right: 100px;"><?php echo ($v["title"]); ?></lable><?php echo ($v["add_time"]); ?>
												<?php if($v["status"] == 0): ?><i id="health<?php echo ($v["message_id"]); ?>" style="margin-left: 30px;">未读</i>
												<?php else: ?>
													<i id="health<?php echo ($v["message_id"]); ?>" style="margin-left: 30px;">已读</i><?php endif; ?>
											</a>
										</h4>
									</div>
									<div class="panel-collapse collapse" id="healthdiv<?php echo ($v["message_id"]); ?>" style="height: 0px;">
					...
					<div class="tab-pane" id="notice">
						<div id="noticediv" class="panel-group">
							<!-- 循环开始 -->
							<?php if(is_array($askMessageArray)): $i = 0; $__LIST__ = $askMessageArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="panel panel-default" style="margin-top: 0px;">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="collapsed" data-toggle="collapse" data-parent="#noticediv" href="#noticediv<?php echo ($v["message_id"]); ?>" onclick="ChangeState(<?php echo ($v["message_id"]); ?>,'notice',<?php echo ($v["status"]); ?>);"> 
											<lable style="width:100px;margin-right: 100px;"><?php echo ($v["title"]); ?></lable><?php echo ($v["add_time"]); ?>
												<?php if($v["status"] == 0): ?><i id="notice<?php echo ($v["message_id"]); ?>" style="margin-left: 30px;">未读</i> 
												<?php else: ?> 
													<i id="notice<?php echo ($v["message_id"]); ?>" style="margin-left: 30px;">已读</i><?php endif; ?>
											</a>
										</h4>
									</div>
									<div class="panel-collapse collapse" id="noticediv<?php echo ($v["message_id"]); ?>" style="height: 0px;">
										<div class="panel-body"><?php echo ($v["content"]); ?></div>
									</div>
								</div><?php endforeach; endif; else: echo "" ;endif; ?>
							<!-- 循环结束 -->
