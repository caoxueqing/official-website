	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				<a href="javascript:;" style="float: left">历史数据</a>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
				<table id="mainTable" class="table table-bordered table-striped">
					...
					<tbody>
						<?php if($reportArray != NULL): if(is_array($reportArray)): $i = 0; $__LIST__ = $reportArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="report">
									<!--选框-->
									<!--<td class="ck"><input type="checkbox" name="id[]"  value="<?php echo ($message["message_id"]); ?>"  class="check"/></td>-->
						...
						<?php else: ?>
							<p style="font-size: 14px; color: #666; text-align: center; height: 200px; line-height: 200px;" class="noShop">对不起，没有心电贴报告信息！</p><?php endif; ?>
					</tbody>
				</table>
				<div class="pages">
                    <?php echo ($page); ?>
				...
				<div class="form-group">
					...
					<?php if(is_array($reportArray)): $i = 0; $__LIST__ = $reportArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="img" id="localImag">
							<?php if($vo['report_url'] != NULL): ?><!-- <img src="<?php echo ($vo["report_url"]); ?>" alt="" style="margin-top: 0px; margin-bottom: 10px;" /> -->
								<a href="<?php echo ($vo["report_url"]); ?>">报告图片</a>
							<?php else: ?>
								<p style="font-size: 14px; color: #666; text-align: center; height: 200px; line-height: 200px;" class="noShop">对不起，没有报告图片！</p><?php endif; ?>
